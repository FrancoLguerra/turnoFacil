...
--
-- Servidor: localhost
-- Tiempo de generación: 29-11-2022 a las 00:08:53
...
(16, 2, 'CPENA', 'Ramos', '40943011', 'IOMA', '5', '09:00'),
(17, 2, 'CPENA', 'lugercio', '3241234124', 'IOMA', '5', '00:00');
...
--
ALTER TABLE `turno_paciente`
  MODIFY `nro_comprobante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
