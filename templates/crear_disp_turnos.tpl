...
<div class="col-6 display-flex">
    <div class="input-group mb-3">
        ...
        <form action="altaDisp" method="POST" autocomplete="off">
            <input type="text" class="form-control" id="hora-inicio" name="horario_inicio" placeholder="Hora de inicio" aria-label="Hora de inicio" aria-describedby="basic-addon3" required>
            <input type="text" class="form-control" id="hora-fin" name="horario_fin" placeholder="Hora de fin" aria-label="Hora de fin" aria-describedby="basic-addon3" required>
