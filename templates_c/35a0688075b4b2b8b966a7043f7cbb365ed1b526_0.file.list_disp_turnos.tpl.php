...
function content_6369b846445d65_30415189 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
     <label id="a" class="title">Turnos disponibles</label>
        <?php if ((isset($_SESSION['USER_ID']))) {?>
        <a class='btn btn-primary' href='crearDisp/<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
'>Crear</a> 
        <?php }?>
